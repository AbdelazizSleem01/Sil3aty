    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        try {
          ...
          // Do not enforce password complexity here — keep complexity checks
          // at registration/change-password flows. At login we only need a
          // present password so remove validatePassword to allow existing
          // users with simpler passwords to sign in.
