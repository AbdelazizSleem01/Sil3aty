  ...
  if (loading) return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 p-6 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-primary text-lg font-semibold">Loading Amazing Team...</p>
      </div>
    </div>
  );
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center items-center space-x-8 mt-8 text-primary/60">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold">{teamMembers.length}+ Members</span>
            </div>
            <div className="flex items-center space-x-2">
              <FaHeart className="text-red-400" />
              <span className="font-semibold">Passionate Team</span>
            </div>
          </div>
        </div>
        ...
        {teamMembers.length === 0 ? (
          <div className="card bg-white shadow-2xl max-w-md mx-auto border border-primary/20">
            <div className="card-body text-center py-12">
              ...
              <h2 className="text-2xl font-bold text-primary mb-2">Our Team is Growing</h2>
              <p className="text-primary/60">Check back soon to meet our amazing team members</p>
            </div>
          </div>
        ) : (
